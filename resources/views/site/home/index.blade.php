...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="{{ route('profile') }}">Meu perfil</a>
          </li>
          @else
                <li class="nav-item">
            ...
            <div class="device-mockup iphone6_plus portrait white">
              <div class="device">
                <div class="screen">
                  ...
                  <img src="{{asset('css/demo-screen-1.jpg')}}" class="img-fluid" alt="">
                </div>
                <div class="button">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 mx-auto">
          ...
          <div class="badges">
            <a class="badge-link" href="#"><img src="{{asset('css/google-play-badge.svg')}}" alt=""></a>
            <a class="badge-link" href="#"><img src="{{asset('css/app-store-badge.svg')}}" alt=""></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <script src="{{asset('css/new-age.min.js')}}"></script>
